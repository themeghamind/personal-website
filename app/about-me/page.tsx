...
export default function Page() {
    return (
        <section>
            ...
            <p className="text-lg [font-family:var(--font-instrument)] mb-4 tracking-wide"> I am a systems thinker at heart, and spend a lot of time exploring the intersection of AI + the grid. Outside of building apps and writing, I enjoy reading scifi, running, hiking, and playing the violin. </p>
            <p className="text-lg [font-family:var(--font-instrument)] mt-4 mb-4 tracking-wide"> Hit me up if you want to grab and trying <a className="hover:underline text-[#0B99FF]" href="https://maps.app.goo.gl/WEiBzwYQobnwjNZu7">matcha or coffee</a>: </p>
            <PageButtons pages={[
                {
