...
export default function Page() {
    return (
        <section>
            ...
            <p className="text-lg [font-family:var(--font-instrument)] mt-4 mb-4 tracking-wide"> Hit me up if you want to grab <a className="hover:text-[#0B99FF]" href="https://maps.app.goo.gl/WEiBzwYQobnwjNZu7">matcha or coffee</a>: </p>
            <PageButtons pages={[
                {
