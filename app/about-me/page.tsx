...
export default function Page() {
    return (
        <section>
            ...
            <p className="text-lg [font-family:var(--font-instrument)] mb-4 tracking-wide"> Outside of building full stack apps and writing, I enjoy exploring <a className="hover:text-[#0B99FF]" href="https://maps.app.goo.gl/Tutkd7ZviNUsB4kE6"> new restaurants </a> and matcha spots in SF, reading scifi, and exploring the great outdoors. </p>
